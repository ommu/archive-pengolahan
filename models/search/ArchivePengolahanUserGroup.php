 ...
 *
 * ArchivePengolahanUserGroup represents the model behind the search form about `ommu\archivePengolahan\models\ArchivePengolahanUserGroup`.
 *
...
use ommu\archivePengolahan\models\ArchivePengolahanUserGroup as ArchivePengolahanUserGroupModel;

class ArchivePengolahanUserGroup extends ArchivePengolahanUserGroupModel
{
	/**
	 * {@inheritdoc}
	 */
	public function rules()
	{
		return [
			...
			[['name', 'permission', 'creation_date', 'modified_date', 'updated_date', 'creationDisplayname', 'modifiedDisplayname'], 'safe'],
		];
	}
	...
	public function search($params, $column=null)
	{
        if (!($column && is_array($column))) {
            $query = ArchivePengolahanUserGroupModel::find()->alias('t');
        } else {
            $query = ArchivePengolahanUserGroupModel::find()->alias('t')
                ->select($column);
        }
		...
		$query->andFilterWhere(['like', 't.name', $this->name])
			->andFilterWhere(['like', 't.permission', $this->permission])
