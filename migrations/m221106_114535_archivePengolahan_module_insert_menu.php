	...
	public function up()
	{
        ...
        if (Yii::$app->db->getTableSchema($tableName, true)) {
			$this->batchInsert($tableName, ['name', 'module', 'icon', 'parent', 'route', 'order', 'data'], [
				['SIKS (Pelestarian)', 'archive-pengolahan', 'fa-archive', null, '/#', null, null],
			]);

			$this->batchInsert($tableName, ['name', 'module', 'icon', 'parent', 'route', 'order', 'data'], [
				['Penyerahan', 'archive-pengolahan', null, Menu::getParentId('SIKS (Pelestarian)#archive-pengolahan'), '/archive-pengolahan/penyerahan/admin/index', 1, null],
				['Senarai Luring', 'archive-pengolahan', null, Menu::getParentId('SIKS (Pelestarian)#archive-pengolahan'), '/archive-pengolahan/luring/admin/index', 2, null],
				['Archive Locations', 'archive-pengolahan', null, Menu::getParentId('SIKS (Pelestarian)#archive-pengolahan'), '/archive-pengolahan/location/index', 3, null],
				['Archive Settings', 'archive-pengolahan', null, Menu::getParentId('SIKS (Pelestarian)#archive-pengolahan'), '/#', 4, null],
			]);
